...
cp node_modules/qrcode/build/qrcode.min.js	 $TARGETFOLDER/$WEBFOLDERNAME
cp node_modules/requirejs/require.js	 $TARGETFOLDER/$WEBFOLDERNAME
...
cat app.css css/ElementList.css css/EditEntryForm.css css/NewEntryForm.css css/Navbar.css css/ShowDetail.css > $TARGETFOLDER/$WEBFOLDERNAME/app.css
